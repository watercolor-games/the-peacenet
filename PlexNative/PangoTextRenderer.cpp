...
template <typename T> Glib::RefPtr<Pango::Layout> CreateLayout(std::string text, std::string typeface, double pointsize, int32_t styles, int32_t wrapmode, int32_t wrapwidth, T context)
{
...
int64_t MeasureString(char* text, int32_t textlen, char* typeface, int32_t typefacelen, double pointsize, int32_t styles, int32_t wrapmode, int32_t wrapwidth)
{
	Pango::init();
	...
	auto layout = CreateLayout(std::string(text, textlen), std::string(typeface, typefacelen), pointsize, styles, wrapmode, wrapwidth, context);
...
void DrawString(char* text, int32_t textlen, char* typeface, int32_t typefacelen, double pointsize, int32_t styles, int32_t wrapmode, int32_t wrapwidth, double r, double g, double b, double a, int32_t w, int32_t h, unsigned char* buffer)
{
	Pango::init();
