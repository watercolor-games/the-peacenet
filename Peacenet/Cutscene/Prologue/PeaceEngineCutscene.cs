...
{
    public class PeaceEngineCutscene : Plex.Engine.Cutscene.Cutscene
    {
        ...
        public override string Name => "m00_peaceengine";
        ...
        {
            string an = "Powered by";
            string watercolor = "Peace Engine";
            string presents = "and MonoGame";
